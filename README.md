...
function updateCalculation() {
  ...
  if (cutting === 0 || sheets === 0) {
    noteMsg.textContent = "⚠️ This paper + material combination is not valid.";
    return;
  }
  ...
  for (let i = 1; i <= numBooks; i++) {
    ...
    document.getElementById("total" + i).innerText = subtotal ? subtotal : 0;
    totalPages += subtotal;
  }
  ...
  resultBody.innerHTML = `
    ...
    <tr><td>Total Packages Needed</td><td>${totalPackages.toFixed(2)}</td></tr>
  `;
